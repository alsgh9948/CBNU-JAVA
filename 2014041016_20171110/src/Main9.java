...
class MenuTest1 extends Frame 
{
	public MenuTest1(String str) 
	{
		...
		Menu support = new Menu("도움말");
		MenuItem support_search = new MenuItem("검색");
		MenuItem support_center = new MenuItem("고객센터");
		
		support.add(support_search);
		support.add(support_center);
